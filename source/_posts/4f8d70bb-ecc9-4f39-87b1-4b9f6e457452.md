---
{"category": "Kotlin ORM libraries", "created": "2022-12-22T01:46:12.322Z", "date": "2022-12-22 01:46:12", "description": "Kotlin ORM libraries like Hibernate, Room, and Exposed offer type-safe SQL queries through Ktor-Exposed for database connections. Spring Framework in Kotlin leverages AOP for cross-cutting concerns and includes basic MVC controllers. JSP can be used with Spring Boot to create apps, handle requests, and process HTTP GETs using the @GetMapping annotation.", "modified": "2022-12-22T01:52:02.406Z", "tags": ["kotlin", "orm", "libraries", "hibernate", "room", "exposed", "ktor-exposed"], "title": "spring, orm, kotlin, yaml config, jsp"}
