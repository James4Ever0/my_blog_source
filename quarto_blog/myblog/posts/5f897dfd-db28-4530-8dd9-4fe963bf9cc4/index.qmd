---
{"categories": &id001 ["Qzone automation", "Modules and tools", "Replacing qzone module", "Logging in via QR code", "Uploading files with Playwright", "AnimeAPI for shuoshuo", "Automating activities"], "category": "Automation", "date": "2023-12-22 23:52:59", "description": "This article explores different methods for automating Qzone activities using various modules and tools. It covers replacing the qzone module, logging in via QR code, uploading files with Playwright, and utilizing the AnimeAPI for more than just sending shuoshuo.", "tags": *id001, "title": "qzone send shuoshuo"}
