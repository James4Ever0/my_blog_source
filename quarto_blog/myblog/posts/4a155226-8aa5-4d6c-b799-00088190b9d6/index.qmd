---
{"categories": &id001 ["audio analysis", "language classification", "language recognization", "localization", "OCR", "pyjom", "speech recognization"], "category": "Natural Language Processing", "date": "2022-08-08 09:47:54", "description": "This article delves into the process of identifying languages in videos through the utilization of various tools, such as SpeechRecognition, paddlespeech, Google Cloud ML, EasyOCR, langid, textcat, and more. These tools facilitate language detection in both audio and textual content within videos.", "tags": *id001, "title": "识别视频语言"}
