---
{"categories": &id001 ["freelancer", "hack"], "category": "hacking", "date": "2023-12-22 23:52:59", "description": "The article discusses hacking attempts on lixin.edu.cn and the use of tools such as dirbuster and Kali Linux to find vulnerabilities. It also includes a HTTP request command for changing passwords on the server.", "tags": *id001, "title": "The Hack (Get password and tests)"}
