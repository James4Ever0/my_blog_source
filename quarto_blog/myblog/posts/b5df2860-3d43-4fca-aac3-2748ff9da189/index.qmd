---
{"categories": &id001 ["BFG Repo Cleaner", "GitHub", "Sensitive data removal", "jar file", "brew installation", "alternative tools", "conversion cheat sheet"], "category": "Data Security", "date": "2023-12-22 23:52:59", "description": "This article provides step-by-step instructions on how to remove sensitive data from a GitHub repository using BFG Repo Cleaner. It highlights the benefits of using BFG over other tools and offers a conversion cheat sheet for those who prefer using Git Filter-Repo.", "tags": *id001, "title": "Remove bad/large files from git repo history"}
