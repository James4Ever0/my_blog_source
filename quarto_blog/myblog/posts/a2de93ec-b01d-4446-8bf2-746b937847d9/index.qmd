---
{"categories": &id001 ["NTFS", "recovery", "remedy", "system manage", "undelete"], "category": "NTFS Recovery Tools", "date": "2023-12-22 23:52:59", "description": "This article discusses NTFS recovery tools for retrieving bilibili cookies from AutoUP and emphasizes the importance of unmounting the disk before scanning. It provides various methods, including using adb shell commands with pv or netcat/gzip, and mentions solutions to LF encoding issues.", "tags": *id001, "title": "NTFS recovery tool for bilibili cookie under AutoUP"}
