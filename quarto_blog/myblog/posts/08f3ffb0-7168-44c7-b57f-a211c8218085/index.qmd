---
{"categories": &id001 ["macos", "terminal", "trash", "cli", "trash-cli", "cmdutils", "cmd-recycle"], "category": "Trash Management", "date": "2023-12-22 23:52:59", "description": "Learn how to empty the trash on MacOS using a terminal and discover an alternative cross-platform CLI tool called 'trash-cli' for managing your personal recycle bin. Additionally, explore other related tools such as cmdutils, cmd-recycle, and nircmd for Windows.", "tags": *id001, "title": "recycle bin, trash can cli alternative"}
