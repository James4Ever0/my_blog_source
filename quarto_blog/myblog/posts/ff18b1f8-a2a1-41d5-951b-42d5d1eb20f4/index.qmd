---
{"categories": &id001 ["freelancer"], "category": "Biology", "date": "2023-12-22 23:52:59", "description": "In this assignment, students are tasked with categorizing antimicrobial and antibiofilm peptide sequences using feature extraction techniques by the due date of January 25, 2020. Throughout the process, students must submit daily reports and compile a final PDF report for evaluation. The grading criteria and additional opportunities for earning extra credit are specified.", "tags": *id001, "title": "DNA Cancer Prediction"}
