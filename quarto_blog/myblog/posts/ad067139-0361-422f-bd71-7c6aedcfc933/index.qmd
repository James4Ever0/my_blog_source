---
{"categories": &id001 ["stock data", "APIs", "TradeX.dll", "BQTradeX", "Quantaxis", "TdxTradeServer", "NewSinaFinance API"], "category": "Stock Data", "date": "2023-12-22 23:52:59", "description": "This article provides resources for acquiring and processing tick-level stock data, such as APIs like TradeX.dll and BQTradeX, and tools like Quantaxis and TdxTradeServer. It specifically focuses on obtaining day, minute, and tick-level data from China's NewSinaFinance API.", "tags": *id001, "title": "股票数据源 tick级别数据源 逐笔交易"}
