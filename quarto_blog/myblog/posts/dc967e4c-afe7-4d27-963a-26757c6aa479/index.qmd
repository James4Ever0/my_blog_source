---
{"categories": &id001 ["advanced search", "information gathering", "search", "semantic search"], "category": "Search Methods", "date": "2022-08-23 04:18:28", "description": "This article explores different search techniques, such as collaborative filtering and recommendation engines, along with random and heuristic libraries. It delves into scraping Twitch chat and predicting memes, detecting trending topics or videos using official APIs, recursive searching with filters and updates, topic modeling via Gensim, and identifying fake news in web browsers.", "tags": *id001, "title": "递归搜索 启发式搜索"}
