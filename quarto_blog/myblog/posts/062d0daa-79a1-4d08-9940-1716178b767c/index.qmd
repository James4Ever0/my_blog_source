---
{"categories": &id001 ["Java", "Kotlin", "Tutorials", "Stream API", "List Comprehension", "Switch Expressions", "Eclipse", "JetBrains Plugin", "Beanshell Syntax Highlighting", "Array Element Occurrences"], "category": "Programming Languages", "date": "2022-12-15 10:39:10", "description": "This guide offers tutorials in Java and Kotlin, covering patterns like Java Stream, list comprehension, switch expressions, and iterating through lists with indices. Additionally, it discusses eclipse and JetBrains plugin support for BeanShell syntax highlighting. The guide also teaches various methods to count array element occurrences in both languages.", "tags": *id001, "title": "useful java patterns"}
