---
{"categories": &id001 ["information gathering", "scraping", "stub", "taobao", "video"], "category": "Open-source Android Automation", "date": "2023-12-22 23:52:59", "description": "Auto.js is an open-source Android automation tool that allows for quick feature launches in apps like Tencent Weishi and Taobao short videos using Scheme URLs and Intent interception, providing a more streamlined alternative to professional testing tools like Appium or AirTest.", "tags": *id001, "title": "ui automation and indirect intent interception (share to)"}
