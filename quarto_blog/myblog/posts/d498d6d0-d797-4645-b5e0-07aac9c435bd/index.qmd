---
{"categories": &id001 ["disk expansion", "system manage", "virtualbox", "virtualization"], "category": "Virtualization", "date": "2023-12-22 23:52:59", "description": "This article provides a detailed guide on how to resize VMDK files in Oracle VirtualBox on Windows 7 using either command prompt or GParted Live CD. The process involves downloading the GParted ISO, creating a new virtual machine, resizing partitions, and applying changes.", "tags": *id001, "title": "how to extend vmdk in oracle virtualbox"}
