---
{"categories": &id001 ["book scanning", "batch scanning", "learning books", "dual-sided scanner", "book binding machine", "OCR recognition", "latex recognition"], "category": "book scanning", "date": "2023-12-22 23:52:59", "description": "This article discusses the process of batch scanning and learning books, including tips on cutting, scanning, binding, and storing. It also covers recognizing content using OCR and latex recognition tools, indexing, searching for content, and utilizing BM25 search and visual recognition to restore the original structure in markdown format. The article suggests adding organized data to ChatGPT or RETRO models' pre-trained datasets.", "tags": *id001, "title": "批量扫描书 批量学习理解全流程"}
